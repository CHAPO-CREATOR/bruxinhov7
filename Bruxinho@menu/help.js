...
\`\`\`MEU CANAL NO YT: https://youtu.be/hwJ31n05Qwk\`\`\`
...
┣⊱  \`\`\`TANGGAL:\`\`\` *${tanggal}*
┣⊱  \`\`\`VERSAO:\`\`\` *3.0.0*
┣⊱  \`\`\`UTILIZADOR TERDAFTAR:\`\`\` *${user.length} User*
┣⊱  ❌ *SPAM*
┣⊱  ❌ *CALL & VC*
...
│
│➻ *${prefix}stiker* [FAZER FIGURINHA]
│➻ *${prefix}gifstiker* [FAZER FIGURINHA ANIMADAS]
│➻ *${prefix}toimg* [TRANSFORMAR FIGURINHA EM FOTO]
│➻ *${prefix}img2url*
│➻ *${prefix}tomp3*
│➻ *${prefix}ocr*
┬
...
╭───────「 *𝐴𝑃𝐸𝑁𝐴𝑆 𝐸𝑀 𝐺𝑅𝑈𝑃𝑂* 」
┴
│➻ *${prefix}welcome On/Off* [dar boas vindas]
│➻ *${prefix}grup buka/tutup* [abrir e fechar o grupo]
│➻ *${prefix}antilink on/off* [NN FUNCIONA]
│➻ *${prefix}ownergrup* 
│➻ *${prefix}setpp*
│➻ *${prefix}infogc*
│➻ *${prefix}add 55𝑋𝑋𝑋𝑋𝑋𝑋*
...
│➻ *${prefix}spamsms 083xxxxxxxx/total *
│➻ *${prefix}spamgmail Bruxinho@gmail.com*
┬
╰────────────────────────
...
│➻ *${prefix}ytmp3 link yt [ERRO]*
│➻ *${prefix}ytmp4 link yt [ERRO]*
